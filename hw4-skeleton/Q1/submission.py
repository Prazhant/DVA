...
def author():                                                                                             
        return "pkubsad3" # replace gburdell3 with your Georgia Tech username.
                                                                                              
def gtid():                                                                                               
    return 903608055 # replace with your GT ID number
    ...
    def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
        ...
        #############################################
                if new_pr_values[source] == 0:
                    new_pr_values[source] += (1 - damping_factor) * node_weights[source]
